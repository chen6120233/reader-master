...
public class CatalogActivity extends BaseActivity<CatalogPresenter>
    ...
    private String mUrl; // 传递当前小说的 url
    private String mName; // 传递当前小说的名字
    private String mCover;// 传递当前小说的封面
    ...
    protected void initView() {
        ...
        mCatalogListRv.setLayoutManager(manager);
    ...
    public void getCatalogDataSuccess(CatalogData catalogData) {
        ...
        MoveToPosition(manager,mCatalogListRv,mChapterIndex);
    }
